...
1. Введение
1.1. Определение пространств имен
1.1.1. Используемые пространства имен
1.2. Обзор классов и свойств
1.2.1. Свойства объекта
1.2.2. Свойства данных
1.2.3. Поименованные классы
1.3. Описание Data cube
1.3.1. Оси куба
1.3.2. Меры куба
2. Перекрестные ссылки: классы, свойства и свойства данных
